...
const char* tema = "wemos_luz_salon"; //tema al que se suscribe
const char* tema_confirmacion = "wemos_luz_salon_confirmacion"; //tema en el que se publican las confirmación de las órdenes
